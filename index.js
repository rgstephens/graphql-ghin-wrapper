...
function extractGolferObject(golfer) {
  ...
  return {
    ...
    address1: golfer.Address1 && golfer.Address1.constructor === Object ? '' : golfer.Address1,
    address2: golfer.Address2 && golfer.Address2.constructor === Object ? '' : golfer.Address2,
